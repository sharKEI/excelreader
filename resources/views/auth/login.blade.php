		...
		<div class="m-stack m-stack--hor m-stack--desktop">
							...
							{{ Form::open(['route' => ['login'], 'class' => 'm-login__form m-form']) }}
								...
								<div class="row m-login__form-sub">
									...
									<div class="col m--align-right">
										<a href="javascript:Swal.fire('Forgot your password. Please contact the admin.');"  class="m-link">Forgot Password ?</a>
									</div>
								</div>
				...
				<div class="m-stack__item m-stack__item--center">
					...
					<div class="m-login__account">
						...
						<a href="javascript:;" id="m_login_signup" class="m-link m-link--focus m-login__account-link">Register</a>
					</div>

				</div>
		</div>
	</div>
	<div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content m-grid-item--center" style="background-image: url(./assets/app/media/img/bg/TNB-6.jpg); background-position: 45px -145px">
