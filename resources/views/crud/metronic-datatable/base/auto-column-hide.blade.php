...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Auto Column Hide</title>
		<meta name="description" content="Datatable auto column hide">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Auto Column Hide</h3>
							</div>
							<div>
					...
					<!-- END: Subheader -->
					<div class="m-content">
						<code>Partial not found: C:\wamp64\www\keenthemes\themes\themes\metronic\dist\preview\inc/view/demos/default/pages/crud/metronic-datatable/base/auto-column-hide.php</code> </div>
				</div>
			</div>
		...
		<!--begin::Page Scripts -->
		<script src="../../../assets/demo/custom/crud/metronic-datatable/base/auto-column-hide.js" type="text/javascript"></script>
