...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Responsive Columns</title>
		<meta name="description" content="Responsive columns examples">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
											...
											<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													...
													<li class="m-menu__item " aria-haspopup="true"><a href="../../../crud/metronic-datatable/base/column-width" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Column
																Width</span></a></li>
													<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../../crud/metronic-datatable/base/responsive-columns" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Responsive Columns</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Responsive Columns</span>
										</a>
									</li>
								</ul>
							</div>
					...
					<div class="m-content">
						<div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
							...
							<div class="m-alert__text">
								The Metronic Datatable allows to set responsive settings for columns indivudlaly to show or hide columns for specific breakpoints(e.g: mobile, tablet, desktop). To try this example in action please try to resize your browser to simulate
		...
		<!--begin::Page Scripts -->
		<script src="../../../assets/demo/custom/crud/metronic-datatable/base/responsive-columns.js" type="text/javascript"></script>
