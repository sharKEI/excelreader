...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Bootstrap Select</title>
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
										...
										<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
											...
											<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													...
													<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../../crud/forms/widgets/bootstrap-select" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Bootstrap
																Select</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Bootstrap Select</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Bootstrap Select</span>
										</a>
									</li>
								</ul>
							</div>
					...
					<div class="m-content">
							...
							<form class="m-form m-form--fit m-form--label-align-right">
								<div class="m-portlet__body">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<select class="form-control m-bootstrap-select m_selectpicker" data-size="4">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
												<option>Tent</option>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<select class="form-control m-bootstrap-select m_selectpicker" data-width="" title="Auto">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
											</select>
									...
									<div class="form-group m-form__group row">
										<label class="col-form-label col-lg-3 col-sm-12">Group Input</label>
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="input-group m-input-group">
												<div class="input-group-prepend"><span class="input-group-text"><i class="la la-exclamation-triangle"></i></span></div>
												<select class="form-control m-bootstrap-select m_selectpicker" name="param">
											...
											<div class="input-group">
												<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></span></div>
												<select class="form-control m-bootstrap-select m_selectpicker" name="param">
													<option value="AK">Option 1</option>
													<option value="AK">Option 2</option>
													<option value="AK">Option 3</option>
												...
												<div class="input-group-append"><span class="input-group-text"><i class="la la-registered"></i></span></div>
											</div>
											<div class="m--space-10"></div>
											<div class="input-group">
											...
											<div class="input-group m-input-group m-input-group--pill">
												<div class="input-group-prepend">
													<span class="input-group-text" id="basic-addon1"><i class="la la-gear"></i></span>
												</div>
												<select class="form-control m-bootstrap-select m_selectpicker" name="param">
													<option value="AK">Option 1</option>
													<option value="AK">Option 2</option>
											...
											<div class="input-group">
												<div class="input-group-prepend">
													<button class="btn btn-focus" type="button">Go!</button>
												</div>
												<select class="form-control m-bootstrap-select m_selectpicker" name="param">
													<option value="AK">Option 1</option>
													<option value="AK">Option 2</option>
						...
						<!--begin::Modal-->
						<div class="modal fade" id="m_select_modal" role="dialog" aria-labelledby="" aria-hidden="true">
		...
		<!--begin::Page Scripts -->
		<script src="../../../assets/demo/custom/crud/forms/widgets/bootstrap-select.js" type="text/javascript"></script>
