...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Bootstrap Timepicker</title>
										...
										<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
											...
											<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													...
													<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../../crud/forms/widgets/bootstrap-timepicker" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Bootstrap Timepicker</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Timepicker</span>
										</a>
									</li>
								</ul>
							</div>
										...
										<div class="modal-body">
											<div class="form-group m-form__group row m--margin-top-20">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input class="form-control" id="m_timepicker_1_modal" readonly placeholder="Select time" type="text" />
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-3 col-sm-12">Current Time</label>
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														<input class="form-control m-input" id="m_timepicker_2_modal" readonly placeholder="Select time" type="text" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-clock-o"></i>
															</span>
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														...
														<input class="form-control m-input" id="m_timepicker_3_modal" readonly placeholder="Select time" type="text" />
													</div>
												</div>
											</div>
											<div class="form-group m-form__group row m--margin-bottom-20">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														...
														<input class="form-control m-input" id="m_timepicker_4_modal" readonly value="10:30:20 AM" type="text" />
													</div>
												</div>
											</div>
										</div>
							...
							<form class="m-form m-form--fit m-form--label-align-right">
								<div class="m-portlet__body">
									<div class="form-group m-form__group row has-success">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="input-group timepicker">
												<input class="form-control m-input" id="m_timepicker_1_validate" readonly placeholder="Select time" type="text" />
												<div class="input-group-append">
									...
									<div class="form-group m-form__group row has-danger">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="input-group timepicker">
												<input class="form-control m-input" id="m_timepicker_2_validate" readonly placeholder="Select time" type="text" />
												<div class="input-group-append">
													<span class="input-group-text"><i class="la la-clock-o"></i></span>
												</div>
											</div>
									...
									<div class="form-group m-form__group row has-warning">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="input-group timepicker">
												<input class="form-control m-input" id="m_timepicker_3_validate" readonly placeholder="Select time" type="text" />
												<div class="input-group-append">
													<span class="input-group-text"><i class="la la-clock-o"></i></span>
												</div>
											</div>
