...
<html lang="en">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../components/base/dropdown" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Dropdown</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Dropdown</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Dropdown</span>
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="col-lg-6">
								...
								<div class="m-portlet">
									...
									<div class="m-portlet__body">
																	...
																	<div class="m-dropdown__body">
																		<div class="m-dropdown__content">
																			<ul class="m-nav">
																				...
																				<li class="m-nav__item">
																					<a href="" class="m-nav__link" data-toggle="m-tooltip" title="Tooltip title" data-placement="right" data-skin="dark" data-container="body">
																						<i class="m-nav__link-icon flaticon-info"></i>
																						<span class="m-nav__link-text">FAQ</span>
																					</a>
																				</li>
																				...
																				<li class="m-nav__section m-nav__section--first">
																					<span class="m-nav__section-text">Other</span>
																				</li>
																				<li class="m-nav__item">
																					<a href="" class="m-nav__link">
																						<i class="m-nav__link-icon flaticon-share"></i>
										...
										<div class="m-section">
											<span class="m-section__sub">
												Dropdowns can be toggled via click or hover by setting <code>m-dropdown-toggle="hover"</code> and <code>m-dropdown-toggle="click"</code>:
											</span>
										...
										<div class="m-section">
											<span class="m-section__sub">
												Dropdowns can be shown persistent when toggled by click to avoid closing on mouse click on it<code>m-dropdown-persistent="1"</code>:
											</span>
											<div class="m-section__content">
												<div class="m-dropdown m-dropdown--inline m-dropdown--arrow" m-dropdown-toggle="click" m-dropdown-persistent="1">
								...
								<div class="m-portlet">
									...
									<div class="m-portlet__body">
										...
										<div class="m-section">
											...
											<div class="m-section__content m-demo-dropdowns">
												<div id="m_dropdown_api_1" class="m-dropdown m-dropdown--inline m-dropdown--arrow" m-dropdown-toggle="hover">
													<a href="#" class="m-dropdown__toggle btn btn-primary dropdown-toggle">
														Dropdown 1
													</a>
													<div class="m-dropdown__wrapper">
												...
												<div id="m_dropdown_api_2" class="m-dropdown m-dropdown--inline m-dropdown--arrow" m-dropdown-toggle="click">
													<a href="#" class="m-dropdown__toggle btn btn-brand dropdown-toggle">
														Dropdown 2
													</a>
													<div class="m-dropdown__wrapper">
							...
							<div class="col-lg-6">
								...
								<div class="m-portlet">
									...
									<div class="m-portlet__body">
										...
										<div class="m-section">
											<span class="m-section__sub">
												Dropdowns can be aligned to <code>left</code>, <code>center</code> and <code>right</code>:
											</span>
											<div class="m-section__content m-demo-dropdowns">
												...
												<div class="m-dropdown m-dropdown--inline  m-dropdown--arrow m-dropdown--align-right" m-dropdown-toggle="hover">
												...
												<div class="m-dropdown m-dropdown--inline  m-dropdown--arrow m-dropdown--align-center" m-dropdown-toggle="hover">
													<a href="#" class="m-dropdown__toggle btn btn-brand dropdown-toggle">
														Dropdown - Center
													</a>
													<div class="m-dropdown__wrapper">
										...
										<div class="m-section">
											<span class="m-section__sub">
												Dropdowns support <code>small</code>, <code>medium</code>, <code>large</code> and <code>huge</code> sizes:
											</span>
											<div class="m-section__content m-demo-dropdowns">
												...
												<div class="m--space-10"></div>
												<div class="m-dropdown m-dropdown--inline m-dropdown--huge m-dropdown--arrow m-dropdown--align-right" m-dropdown-toggle="hover">
													<a href="#" class="m-dropdown__toggle btn btn-primary dropdown-toggle">
														Dropdown - Huge
													</a>
													<div class="m-dropdown__wrapper">
										...
										<div class="m-section">
											<span class="m-section__sub">
												Apply <code>m-dropdown--up</code> to display dropdown in opposite mode:
											</span>
											<div class="m-section__content">
												<div class="m-dropdown m-dropdown--up m-dropdown--inline m-dropdown--small m-dropdown--arrow m-dropdown--align-left" m-dropdown-toggle="hover">
													<a href="#" class="m-dropdown__toggle btn btn-brand dropdown-toggle">
														Dropdown - Default
													</a>
													<div class="m-dropdown__wrapper">
										...
										<div class="m-section">
											...
											<div class="m-section__content m-demo-dropdowns">
												<div class="m-dropdown m-dropdown--inline m-dropdown--align-left" m-dropdown-toggle="hover">
													<a href="#" class="m-dropdown__toggle btn btn-success dropdown-toggle">
														Dropdown - No arrow
													</a>
													<div class="m-dropdown__wrapper">
												...
												<div class="m-dropdown m-dropdown--up m-dropdown--inline m-dropdown--align-left" m-dropdown-toggle="hover">
													<a href="#" class="m-dropdown__toggle btn btn-primary dropdown-toggle">
														Dropup - No arrow
													</a>
													<div class="m-dropdown__wrapper">
												...
												<div class="m-dropdown m-dropdown--inline m-dropdown--align-left" m-dropdown-toggle="hover">
													...
													<div class="m-dropdown__wrapper">
														<div class="m-dropdown__inner">
															<div class="m-dropdown__body">
																<div class="m-dropdown__content">
																	<div class="m-scrollable" data-scrollable="true" data-height="200">
																		<ul class="m-nav">
																			<li class="m-nav__section m-nav__section--first">
																				<span class="m-nav__section-text">Section</span>
																			</li>
		...
		<!--begin::Page Scripts -->
		<script src="../../assets/demo/custom/components/base/dropdown.js" type="text/javascript"></script>
