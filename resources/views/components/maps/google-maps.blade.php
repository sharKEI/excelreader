...
<html lang="en">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-placeholder-1"></i><span
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../components/maps/google-maps" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Google
													Maps</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Google Maps</h3>
					...
					<div class="m-content">
						<div class="alert alert-brand m-alert m-alert--icon m-alert--air m-alert--square m--margin-bottom-30" role="alert">
							...
							<div class="m-alert__text">
								...
								For more info please check out <a class="m-link m-link--warning m--font-bold" href="https://hpneo.github.io/gmaps/" target="_blank">the official documentation.</a>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="m-portlet m-portlet--tab">
									...
									<div class="m-portlet__body">
										<form class="m--margin-bottom-20" action="#">
		...
		<!--begin::Page Scripts -->
		<script src="../../assets/demo/custom/components/maps/google-maps.js" type="text/javascript"></script>
