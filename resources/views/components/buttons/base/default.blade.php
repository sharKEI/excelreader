...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Default Style</title>
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
											...
											<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../../components/buttons/base/default" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Default
																Style</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Default Style</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Default Style</span>
										</a>
									</li>
								</ul>
							</div>
									...
									<div class="m-portlet__body">
										...
										<div class="m-section">
											...
											<div class="m-section__content">
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview  m-demo__preview--btn">
														<button type="button" class="btn m-btn m-btn--gradient-from-primary m-btn--gradient-to-info">Primary</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-success m-btn--gradient-to-accent">Success</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-danger m-btn--gradient-to-warning">Danger</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-warning m-btn--gradient-to-danger">Warning</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-info m-btn--gradient-to-accent">Info</button>
													</div>
												</div>
											</div>
											...
											<div class="m-section__content">
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview  m-demo__preview--btn">
														<button type="button" class="btn m-btn m-btn--gradient-from-brand m-btn--gradient-to-info">Primary</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-metal m-btn--gradient-to-accent">Success</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-accent m-btn--gradient-to-success">Danger</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-focus m-btn--gradient-to-danger">Warning</button>
														<button type="button" class="btn m-btn m-btn--gradient-from-info m-btn--gradient-to-warning">Info</button>
													</div>
												</div>
											</div>
											...
											<div class="m-section__content">
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview m-demo__preview--btn">
														...
														<button type="button" class="btn btn-primary m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Primary</button>
														<button type="button" class="btn btn-brand m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Brand</button>
														<button type="button" class="btn btn-success m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Success</button>
														<button type="button" class="btn btn-info m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Info</button>
														<button type="button" class="btn btn-warning m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Warning</button>
														<button type="button" class="btn btn-danger m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Danger</button>
														<button type="button" class="btn btn-accent m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Accent</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Secondary</button>
														<div class="m-separator m-separator--dashed"></div>
														<button type="button" class="btn btn-primary m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Primary</button>
														<button type="button" class="btn btn-brand m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Brand</button>
														<button type="button" class="btn btn-success m-btn m-btn--custom m-btn--bolder m-btn--uppercase">Success</button>
											...
											<div class="m-section__content">
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview m-demo__preview--btn">
														...
														<div class="m-separator m-separator--dashed"></div>
														<button type="button" class="btn btn-outline-primary m-btn m-btn--custom m-btn--outline-2x">Primary</button>
														<button type="button" class="btn btn-outline-brand m-btn m-btn--custom m-btn--outline-2x">Brand</button>
														<button type="button" class="btn btn-outline-success m-btn m-btn--custom m-btn--outline-2x">Success</button>
														<button type="button" class="btn btn-outline-info m-btn m-btn--custom m-btn--outline-2x">Info</button>
														<button type="button" class="btn btn-outline-warning m-btn m-btn--custom m-btn--outline-2x">Warning</button>
														<button type="button" class="btn btn-outline-danger m-btn m-btn--custom m-btn--outline-2x">Danger</button>
														<button type="button" class="btn btn-outline-metal m-btn m-btn--custom m-btn--outline-2x">Metal</button>
														<button type="button" class="btn btn-outline-accent m-btn m-btn--custom m-btn--outline-2x">Accent</button>
														<div class="m-separator m-separator--dashed"></div>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-primary">Primary</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-brand">Brand</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-success">Success</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-info">Info</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-warning">Warning</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-danger">Danger</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-metal">Metal</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-accent">Accent</button>
														<div class="m-separator m-separator--dashed"></div>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-primary m-btn--bolder">Primary</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Brand</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-success m-btn--bolder">Success</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-info m-btn--bolder">Info</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-warning m-btn--bolder m-btn--uppercase">Warning</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-danger m-btn--bolder m-btn--uppercase">Danger</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-metal m-btn--bolder m-btn--uppercase">Metal</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-accent m-btn--bolder m-btn--uppercase">Accent</button>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="m-section__content">
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview m-demo__preview--btn">
														...
														<button type="button" class="btn btn-secondary btn-lg m-btn m-btn--custom m-btn--label-accent">Large button</button>
														<button type="button" class="btn btn-outline-success btn-lg m-btn m-btn--custom">Large button</button>
													</div>
												</div>
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview m-demo__preview--btn">
														<button type="button" class="btn btn-primary m-btn m-btn--custom">Default button</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom m-btn--label-accent">Default button</button>
												...
												<div class="m-demo m-demo--last" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview m-demo__preview--btn">
														...
														<button type="button" class="btn btn-secondary btn-sm m-btn m-btn--custom m-btn--label-accent">Small button</button>
														<button type="button" class="btn btn-outline-success btn-sm m-btn m-btn--custom">Small button</button>
											...
											<div class="m-section__content">
												...
												<div class="m-demo m-demo--last" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview m-demo__preview--btn">
														...
														<div class="m--space-10"></div>
														<button type="button" class="btn btn-primary m-btn m-btn--custom" disabled="disabled">Disabled</button>
														<button type="button" class="btn btn-secondary m-btn m-btn--custom" disabled="disabled">Disabled</button>
														<button type="button" class="btn btn-success m-btn m-btn--custom" disabled="disabled">Disabled</button>
