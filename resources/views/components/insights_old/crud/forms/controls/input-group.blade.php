...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Input Groups</title>
											...
											<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													...
													<li class="m-menu__item " aria-haspopup="true"><a href="../../../crud/forms/controls/checkbox-radio" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Checkbox
																& Radio</span></a></li>
													<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../../crud/forms/controls/input-group" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Input
																Groups</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Input Groups</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Input Groups</span>
										</a>
									</li>
								</ul>
							</div>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group m--margin-top-10">
												<div class="alert m-alert m-alert--default" role="alert">
													Use any icon in input group from <a class="m-link" href="../../../components/icons/lineawesome">Lineawesome</a>, <a class="m-link" href="../../../components/icons/lineawesome">Fontawesome</a> or , <a class="m-link" href="../../../components/icons/lineawesome">Fontawesome</a>
													or <a class="m-link" href="../../../components/icons/lineawesome">Metronic</a> icons.
												</div>
											</div>
