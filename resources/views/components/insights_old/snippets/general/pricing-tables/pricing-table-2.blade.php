...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Pricing Tables v2</title>
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true"><a href="../../../snippets/general/pricing-tables/pricing-table-1" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Pricing
													Tables v1</span></a></li>
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../../snippets/general/pricing-tables/pricing-table-2" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Pricing Tables v2</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Pricing Tables v2</span>
										</a>
									</li>
								</ul>
							</div>
												...
												<div class="m-pricing-table-2__container">
													<div class="m-pricing-table-2__items row">
														<div class="m-pricing-table-2__item col-lg-4">
															...
															<span class="m-pricing-table-2__price">69</span>
														...
														<div class="m-pricing-table-2__item col-lg-4">
															...
															<h2 class="m-pricing-table-2__subtitle">For Business</h2>
															<div class="m-pricing-table-2__features">
															...
															<span class="m-pricing-table-2__price">169</span>
															<span class="m-pricing-table-2__label">$</span>
															<div class="m-pricing-table-2__btn">
																<button type="button" class="btn m-btn--pill  btn-info m-btn--wide m-btn--uppercase m-btn--bolder m-btn--lg">Purchase</button>
															</div>
														...
														<div class="m-pricing-table-2__item col-lg-4">
															...
															<h2 class="m-pricing-table-2__subtitle">Enterprice</h2>
															<div class="m-pricing-table-2__features">
															...
															<span class="m-pricing-table-2__price">669</span>
															<span class="m-pricing-table-2__label">$</span>
															<div class="m-pricing-table-2__btn">
																<button type="button" class="btn m-btn--pill  btn-info m-btn--wide m-btn--uppercase m-btn--bolder m-btn--lg">Purchase</button>
															</div>
												...
												<div class="m-pricing-table-2__container">
													<div class="m-pricing-table-2__items row">
														<div class="m-pricing-table-2__item col-lg-4">
															...
															<span class="m-pricing-table-2__price">19</span>
															<span class="m-pricing-table-2__label">$</span>
															<div class="m-pricing-table-2__btn">
																<button type="button" class="btn m-btn--pill  btn-info m-btn--wide m-btn--uppercase m-btn--bolder m-btn--lg">Purchase</button>
															</div>
														...
														<div class="m-pricing-table-2__item col-lg-4">
															...
															<span class="m-pricing-table-2__price">49</span>
															<span class="m-pricing-table-2__label">$</span>
															<div class="m-pricing-table-2__btn">
																<button type="button" class="btn m-btn--pill  btn-info m-btn--wide m-btn--uppercase m-btn--bolder m-btn--lg">Purchase</button>
															</div>
														...
														<div class="m-pricing-table-2__item col-lg-4">
															...
															<span class="m-pricing-table-2__price">29</span>
															<span class="m-pricing-table-2__label">$</span>
															<div class="m-pricing-table-2__btn">
																<button type="button" class="btn m-btn--pill  btn-info m-btn--wide m-btn--uppercase m-btn--bolder m-btn--lg">Purchase</button>
															</div>
