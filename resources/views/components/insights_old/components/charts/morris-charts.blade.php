...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Morris Charts</title>
		<meta name="description" content="Morris charts examples">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true"><a href="../../components/charts/google-charts" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Google
													Charts</span></a></li>
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../components/charts/morris-charts" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Morris
													Charts</span></a></li>
									</ul>
								</div>
							</li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Morris Charts</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Morris Charts</span>
										</a>
									</li>
								</ul>
							</div>
					...
					<div class="m-content">
						<div class="alert alert-info m-alert m-alert--icon m-alert--air m-alert--square m--margin-bottom-30" role="alert">
							...
							<div class="m-alert__text">
								Morris is customizable and super easy plugin to build good looking charts.
								For more info please check out <a class="m-link m-link--primary m--font-bolder" href="http://morrisjs.github.io/morris.js/" target="_blank">the official documentation.</a>
							</div>
		...
		<!--begin::Page Scripts -->
		<script src="../../assets/demo/custom/components/charts/morris-charts.js" type="text/javascript"></script>
