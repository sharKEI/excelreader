							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../components/base/popover" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Popover</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Popover</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Popover</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<div class="m-portlet">
									...
									<div class="m-portlet__body">
										...
										<div class="m-section">
											...
											<div class="m-section__content">
												<button type="button" class="btn btn-primary" data-toggle="m-popover" data-trigger="focus" title="Popover title" data-html="true" data-content="And here's some amazing <b>HTML</b> content. It's very <code>engaging</code>. Right?">Click
													me</button>
											</div>
										</div>
										...
										<div class="m-section">
											...
											<div class="m-section__content">
												...
												<button type="button" class="btn btn-success" data-trigger="click" data-skin="dark" data-toggle="m-popover" data-placement="bottom" title="Dark skin" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
													Dark skin
												</button>
											</div>
										</div>
