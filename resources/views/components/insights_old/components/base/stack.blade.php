							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../components/base/stack" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Stack</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Stack</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Stack</span>
										</a>
									</li>
								</ul>
							</div>
									...
									<div class="m-portlet__body">
										...
										<div class="m-section">
											<span class="m-section__sub">
												...
												When <code>m-stack--general</code> mode used the stack mode will remain but with other modes, for example with <code>m-stack--tablet</code> the stack mode will be activate within the device width and outside the device with the stack
												will be have just normal block tag.
											</span>
											<div class="m-section__content">
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview">
													...
													<div class="m-demo__preview">
														<div class="m-stack m-stack--hor m-stack--general m-stack--demo" style="height: 400px">
															<div class="m-stack__item m-stack__item--left">
																<div class="m-stack__demo-item">Left aligment</div>
															</div>
															<div class="m-stack__item m-stack__item--center">
																<div class="m-stack__demo-item">Center aligment</div>
															</div>
															<div class="m-stack__item m-stack__item--right">
																<div class="m-stack__demo-item">Right aligment</div>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="m-demo__preview" style="height: 600px">
														<div class="m-stack m-stack--hor m-stack--general m-stack--demo">
															<div class="m-stack__item m-stack__item--center m-stack__item--middle" style="height: 100px;">
																<div class="m-stack__demo-item">Fixed height - 100px</div>
															</div>
															<div class="m-stack__item m-stack__item--center m-stack__item--middle m-stack__item--fluid">
																<div class="m-stack__demo-item">Fluid height - 100%</div>
															</div>
															<div class="m-stack__item m-stack__item--center m-stack__item--middle" style="height: 100px;">
																<div class="m-stack__demo-item">Fixed height - 100px</div>
															</div>
