							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="../../components/base/lists" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Lists</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Lists</h3>
									...
									<div class="m-portlet__body">
										...
										<div class="m-section">
											...
											<div class="m-section__content">
												...
												<!--begin::Dropdown-->
												<div class="m-dropdown m-dropdown--inline m-dropdown--huge m-dropdown--arrow" m-dropdown-toggle="click">
										...
										<div class="m-section">
											...
											<div class="m-section__content">
												...
												<!--begin::Dropdown-->
												<div class="m-dropdown m-dropdown--up m-dropdown--inline m-dropdown--huge m-dropdown--arrow" m-dropdown-toggle="click">
													...
													<div class="m-demo__preview" style="background: #F7F8FC;">
														<div class="m-list-badge">
															...
															<div class="m-list-badge__items">
																<a href="#" class="m-list-badge__item">Technology</a>
																<a href="#" class="m-list-badge__item">Sport</a>
																<a href="#" class="m-list-badge__item">Art</a>
																<a href="#" class="m-list-badge__item">Music</a>
															</div>
														</div>
														<div class="m-list-badge m--margin-top-15">
															<div class="m-list-badge__label m--font-success">13:00</div>
															<div class="m-list-badge__items">
																<span class="m-list-badge__item">Web Design</span>
																<span class="m-list-badge__item">Programming</span>
																<span class="m-list-badge__item">Illustration</span>
															</div>
														</div>
														<div class="m-list-badge m--margin-top-15">
															<div class="m-list-badge__label m--font-success">14:00</div>
															<div class="m-list-badge__items">
																<a href="#" class="m-list-badge__item">Yoga</a>
																<a href="#" class="m-list-badge__item">Cooking</a>
																<a href="#" class="m-list-badge__item">Dance</a>
																<a href="#" class="m-list-badge__item">Gym</a>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="m-demo">
													<div class="m-demo__preview">
														<div class="m-list-pics m-list-pics--rounded m--margin-bottom-10">
															<a href="../../#"><img src="assets/app/media/img/users/user1.jpg" title=""></a>
															<a href="../../#"><img src="assets/app/media/img/users/user2.jpg" title=""></a>
															<a href="../../#"><img src="assets/app/media/img/users/user3.jpg" title=""></a>
															<a href="../../#"><img src="assets/app/media/img/users/user4.jpg" title=""></a>
															<a href="../../#"><img src="assets/app/media/img/users/user5.jpg" title=""></a>
															<a href="../../#"><img src="assets/app/media/img/users/user6.jpg" title=""></a>
														</div>
												...
												<div class="m-dropdown m-dropdown--up m-dropdown--inline m-dropdown--huge m-dropdown--arrow" m-dropdown-toggle="click">
													...
													<div class="m-dropdown__wrapper">
														<div class="m-dropdown__inner">
															<div class="m-dropdown__body">
																<div class="m-dropdown__content">
																	<div class="m-scrollable" data-scrollable="true" data-height="240">
																		<div class="m-list-search">
																			<div class="m-list-search__results">
																				<span class="m-list-search__result-message m--hide">
																					No record found
